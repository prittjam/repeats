...
qres = array2table([data.q*sum(2*sum(sensitivity.cam.cc))^2 ...
                    ...
                    data.rms ... 
                    data.rewarp], ...
                   'VariableNames', {'q','q_relerr','rms','rewarp'}); 
...
ind = find(Lia & Lib);
ax1 = make_grouped_boxplot(res(ind,:), {'q'},{ 'sigma', 'solver' }, ...
...
drawnow;
cleanfigure;
matlab2tikz('/home/prittjam/Documents/eccv18/fig/lambda_sensitivity1.tikz',...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);
keyboard;


ax2 = make_grouped_boxplot(res(ind,:), {'q_relerr'},{ 'sigma', 'solver' }, ...
                           'ylim', [-0.6 0.6], ...
                           'yticks',[-0.8:0.2:0.8], ...
                           'truth', 0.0, ...
                           'location','northwest', ...
...
matlab2tikz(['/home/prittjam/Documents/eccv18/fig/' ...
             'lambda_sensitivity2.tikz'], ...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);


ind = find(Lia & Lic);
ax3 = make_grouped_boxplot(res(ind,:), {'rms'},{ 'sigma', 'solver'}, ...
                           'ylim', [0 40], ...
                           'yticks',[0:10:40], ...
                           'location','northwest', ...
                           'colors', color_list([1:5 7:8],:), ...
                           'ylabel', '$\Delta^{\mathrm{xfer}}_{\mathrm{RMS}}$ [pixels]');
drawnow;
cleanfigure;
matlab2tikz('/home/prittjam/Documents/eccv18/fig/rms_sensitivity.tikz', ...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);

ind = find(Lia & Lid);

ax4 = make_grouped_boxplot(res(ind,:), {'rewarp'},{ 'sigma', 'solver'}, ...
                           'ylim', [0 40], ...
                           'yticks',[0:10:50], ...
                           'location','northwest', ...
