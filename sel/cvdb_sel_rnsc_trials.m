function rnsc_trials = cvdb_sel_rnsc_trials(conn, ...
                                            exp_set_id, titleg, pair_id, type)
connh = conn.Handle;

    stm = connh.prepareStatement(['INSERT INTO rnsc_trials ' ...
                        '(rnsc_id, inlying_set, errors, score) ' ...
                        'VALUES(?,?,?,?)'], ...
                                 java.sql.Statement.RETURN_GENERATED_KEYS);


two_view_results = {};
sql_query = ['SELECT rnsc_id, inlying_set, errors, score FROM ' ...
             'rnsc_trials ' ...
