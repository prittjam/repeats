...
repeats_init();
sensitivity = load('rt_sensitivity_20190303.mat');
color_list = [  ...
    0.5 0 0.5; ...
    1 69/255 0; ...
    0 0 0; ...
...
drawnow;
cleanfigure;
matlab2tikz('/home/jbpritts/Documents/ijcv19/fig2/lambda_sensitivity_rt.tikz',...
            'width', '\fwidth', ...
...
drawnow;
cleanfigure;
matlab2tikz('/home/jbpritts/Documents/ijcv19/fig2/ransac_lambda_sensitivity_rt.tikz',...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);
...
drawnow;
cleanfigure;
matlab2tikz('/home/jbpritts/Documents/ijcv19/fig2/rel_lambda_sensitivity_rt.tikz', ...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);
...
drawnow;
cleanfigure;
matlab2tikz(['/home/jbpritts/Documents/ijcv19/fig2/ransac_rel_lambda_sensitivity_rt.tikz'], ...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);
...
drawnow;
cleanfigure;
matlab2tikz('/home/jbpritts/Documents/ijcv19/fig2/rewarp_sensitivity_rt.tikz', ...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);
...
drawnow;
cleanfigure;
matlab2tikz('/home/jbpritts/Documents/ijcv19/fig/ransac_rewarp_sensitivity_rt.tikz', ...
            'width', '\fwidth', ...
            'extraAxisOptions',axis_options);
