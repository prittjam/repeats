classdef LineSegmentDetector < handle
    ...
    methods
        function this = LineSegmentDetector(varargin)
            ...
            %
            this.id = LINE.LineSegmentDetector_(0, 'new', varargin{:});
        end
        ...
        function delete(this)
            ...
            %
            LINE.LineSegmentDetector_(this.id, 'delete');
        end
    end
    ...
    methods
        function clear(this)
            ...
            %
            LINE.LineSegmentDetector_(this.id, 'clear');
        end
        ...
        function b = empty(this)
            ...
            %
            b = LINE.LineSegmentDetector_(this.id, 'empty');
        end
        ...
        function name = getDefaultName(this)
            ...
            %
            name = LINE.LineSegmentDetector_(this.id, 'getDefaultName');
        end
        ...
        function save(this, filename)
            ...
            %
            LINE.LineSegmentDetector_(this.id, 'save', filename);
        end
        ...
        function load(this, fname_or_str, varargin)
            ...
            %
            LINE.LineSegmentDetector_(this.id, 'load', fname_or_str, varargin{:});
        end
    end
    ...
    methods
        function [lines, width, prec, nfa] = detect(this, img)
            ...
            %         'Advanced'.
            %
            [lines, width, prec, nfa] = LINE.LineSegmentDetector_(this.id, 'detect', img);
        end
        ...
        function img = drawSegments(this, img, lines)
            ...
            %
            img = LINE.LineSegmentDetector_(this.id, 'drawSegments', img, lines);
        end
        ...
        function [img, count] = compareSegments(this, sz, lines1, lines2, varargin)
            ...
            %
            [img, count] = LINE.LineSegmentDetector_(this.id, 'compareSegments', ...
